...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {\includegraphics[height=6.0cm]{logos/logo_ens_psl_blanc_500px.png} \includegraphics[height=7.0cm]{logos/logoUP_inv.png}   \includegraphics[height=6.0cm]{logos/logo_Inserm_inv.png}}; %add here logos for your other affiliations
    \end{tikzpicture}
}
