...
\footercontent{
  \href{https://cognition.ens.psl.eu}{https://cognition.ens.psl.eu} \hfill %Can also be your personal website
...
\addtobeamertemplate{headline}{}
{
    \begin{tikzpicture}[remember picture,overlay]
      ...
      {\includegraphics[height=7.0cm]{logos/logo_ENS_carre.png} \includegraphics[height=7.0cm]{logos/logoUP.png}   \includegraphics[height=6.0cm]{logos/logo_Inserm_inv.png}}; %add here logos for your other affiliations
    \end{tikzpicture}
}
